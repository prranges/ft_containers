...
namespace ft {
    ...
    public:
        ...
        class pair_compare : public std::binary_function<value_type, value_type, bool> {
            friend class map;
        protected:
            key_compare comp;
            pair_compare(key_compare c) : comp(c) {}
        public:
...
//            return _tree->delete_node(_tree->search(key));
//            return _tree->delete_node(find(key));
